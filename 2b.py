numberString = """9-12 q: qqqxhnhdmqqqqjz
...
numbers = numberString.splitlines()
for x in numbers:
    index = numbers.index(x)
    numbers[index] = x.split(" ")
    numbers[index][0] = numbers[index][0].split("-")
...
for x in numbers:
    ...
    if x[2][indexa] == x[1] and x[2][indexb] == x[1]:
        print("n")
    elif x[2][indexa] == x[1] or x[2][indexb] == x[1]:
        print("y")
        totalTally += 1
    else:
        print("n")
